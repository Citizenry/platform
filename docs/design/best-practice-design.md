---
description: Guidance on how to design well for StreetSignal.
---
...
We expect consideration of several aspects when designing for StreetSignal's products:

**1 -** Understanding of the StreetSignal product by using and investigating the tool yourself as well as the varied use cases of the tool. You can learn more about varied use cases by visiting our website [grassroots section](https://www.streetsignal.com/donate) and [case studies like Quakemap](https://www.streetsignal.com/case-studies/quakemap). Familiarity with the tool will help you understand how to design with the users in front of your mind.  
Reviewing the [Pattern library](http://preview.streetsignal.com/platform-pattern-library/develop/index.html) is also very useful.

StreetSignal's products are used in high-stress scenarios. From natural disasters to trauma survivors and human rights activists. Always be aware of the vulnerability of these kinds of users and their safety.
