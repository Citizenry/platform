...
description: >-
  ...
  obstacle in using the StreetSignal Platform was the installation.
---
...
Many of you got stuck during the installation and we suspect many leave after that, not looking back. Therefore we have worked hard on improving our docs and in May we will host our first Installathon, an online Hackathon over one week where the main focus is to help our users to install the StreetSignal Platform.
...
**How can I chat with StreetSignal staff about the installathon?** Visit [http://bit.ly/chatwithstreetsignal](http://bit.ly/chatwithstreetsignal) to chat with the StreetSignal development team on getting up and running with the StreetSignal OSS repo from 2-7 of May 2019.
