...
We log all our issues concerning development and documentation for the StreetSignal Platform in the [Platform-repository](https://github.com/streetsignal/platform/issues). Issues marked with [Community-task](https://github.com/streetsignal/platform/labels/Community%20Task) are issues that are up for grabs for any community-member.

## Submit issues in GitHub

To submit issues in GitHub for the StreetSignal Platform, please go to [https://github.com/streetsignal/platform/issues](https://github.com/streetsignal/platform/issues) and click on the "New Issue" button, _or_ follow [this link](https://github.com/streetsignal/platform/issues/new/choose).
...
* **Feature/enhancement request:** Suggest an idea for a new feature or a small enhancement to existing features. This can be something as big as "Add a new way to import data into the StreetSignal Platform" or as small as "Change the font size of the login button to make it easier to use".
* **Epic level spec**: this is only used when you want to create a very large request that encompasses multiple tickets and is likely to require a lot of work. It is primarily used by the StreetSignal team to group work together and plan for it, so you can ignore it for now.
...
Once you have filled all the requirements for the issue to be submitted, you can click "Submit new Issue" and your issue will be created. **This triggers a notification to one StreetSignal staff who will review it as soon as possible.**  
...
Thank you for reading our guide to submitting a new issue to the StreetSignal Platform. We look forward to hearing from you!
