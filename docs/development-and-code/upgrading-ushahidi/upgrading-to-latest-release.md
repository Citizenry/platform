...
Instructions on how to upgrade your StreetSignal deployment.

1. Make a backup copy of the current folder where you have installed the StreetSignal Platform.
2. Make a backup copy of your database.
   1. The exact procedure to do this depends on your environment.
3. Download the latest .tar.gz file from our [github releases page](https://github.com/streetsignal/platform-release/releases) . Please note that pre-releases are not considered stable and you may find issues with them.
4. Uncompress the downloaded file on the same location where the StreetSignal Platform is currently installed.
