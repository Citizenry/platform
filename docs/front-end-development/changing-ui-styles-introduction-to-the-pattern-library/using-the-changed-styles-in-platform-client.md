...
4. Find the entry for **streetsignal-pattern-library**
5. Change to the url to the new repository + the new pattern library commit id  in this format: _"streetsignal-platform-pattern-library":"git://github.com/{your-own org}/streetsignal-platform-pattern-library-sivico.git\#{commit}"_
6. Do **npm install** in the platform-client
7. Go to **platform-client/node\_modules/streetsignal-pattern-library**
8. Run **npm install** there too \(this step is normally made by npm when using the StreetSignal-release so you need to do it yourself when using your own code\)
...
6. Find “streetsignal-pattern-library” and change to "YourProjectName-Pattern-Library": "v3.12.4" \(substitute version number to the one you published\)
