...
namespace StreetSignal\Multisite;
...
class MultisiteManager
{
    ...
    /**
     * @var \StreetSignal\Multisite\SiteRepository
     */
    protected $repo;
    ...
    /**
     * @var \StreetSignal\Multisite\Site
     */
     ...
     * @param string $host
     * @return void
     * @throws \StreetSignal\Multisite\SiteNotFoundException
     */
