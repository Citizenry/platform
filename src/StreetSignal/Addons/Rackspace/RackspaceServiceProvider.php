...
namespace StreetSignal\Addons\Rackspace;
...
use StreetSignal\Addons\Rackspace\Identity\Api;
...
class RackspaceServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        Storage::extend('rackspace', function ($app, $config) {
            ...
            /** @var \StreetSignal\Addons\Rackspace\CDN\Service $cdnService */
    ...
    {
        $openstack = new Builder($options, 'StreetSignal\Addons');
