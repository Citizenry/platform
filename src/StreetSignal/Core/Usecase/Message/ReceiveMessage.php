...
/**
 * StreetSignal Platform Receive Message Use Case
 *
...
class ReceiveMessage extends CreateUsecase
{
    ...
    /**
     * @var \StreetSignal\Contracts\Repository\Entity\ContactRepository
     */
    protected $contactRepo;

    /**
     * @var \StreetSignal\Contracts\Validator
     */
    ...
    public function interact()
    {
        ...
        /*
         * re: github.com/streetsignal/platform/issues/2111
     ...
     *
     * @return \StreetSignal\Contracts\Entity $contact
     */
     ...
     *
     * @param  \StreetSignal\Contracts\Entity $contact
     * @return int
     */
     ...
     * @throws \StreetSignal\Core\Exception\ValidatorException
     */
     ...
     *
     * @param \StreetSignal\Contracts\Entity $entity
     * @throws \StreetSignal\Core\Exception\AuthorizerException
     */
