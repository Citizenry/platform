...
/**
 * StreetSignal Platform Post Export Use Case
 *
...
use StreetSignal\Modules\V3\Repository\HXL\HXLFormAttributeHXLAttributeTagRepository;
...
class ExportPost implements Usecase
{
    ...
    /**
     * @var \StreetSignal\Contracts\Repository\Entity\ExportBatchRepository
     */
    protected $repo;
