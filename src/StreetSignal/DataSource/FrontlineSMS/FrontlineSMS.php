...
namespace StreetSignal\DataSource\FrontlineSMS;
...
use StreetSignal\DataSource\Contracts\MessageType as MessageType;
use StreetSignal\DataSource\Contracts\MessageStatus as MessageStatus;
...
class FrontlineSMS implements CallbackDataSource, OutgoingDataSource
{
    ...
    {
        $router->post('sms/frontlinesms', 'StreetSignal\DataSource\FrontlineSMS\FrontlineSMSController@handleRequest');
        $router->post('frontlinesms', 'StreetSignal\DataSource\FrontlineSMS\FrontlineSMSController@handleRequest');
    }
