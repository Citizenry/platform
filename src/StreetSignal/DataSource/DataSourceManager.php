...
namespace StreetSignal\DataSource;
...
class DataSourceManager
{
     ...
     *
     * @var \StreetSignal\Contracts\Repository\Entity\ConfigRepository|null;
     */
     ...
     *
     *
     * @var \StreetSignal\DataSource\Contracts\DataSource[]
     */
     ...
     *
     * @param  \StreetSignal\Contracts\Repository\Entity\ConfigRepository  $configRepo
     * @return void
     */
    ...
    public function registerRoutes(Router $router)
    {
        ...
        /** @var \StreetSignal\DataSource\Contracts\CallbackDataSource $class */
