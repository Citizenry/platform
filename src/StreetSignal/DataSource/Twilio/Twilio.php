...
namespace StreetSignal\DataSource\Twilio;
...
class Twilio implements CallbackDataSource, OutgoingDataSource
{
    ...
    {
        $router->post('sms/twilio', 'StreetSignal\DataSource\Twilio\TwilioController@handleRequest');
        $router->post('sms/twilio/reply', 'StreetSignal\DataSource\Twilio\TwilioController@handleRequest');
    }
