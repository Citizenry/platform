...
namespace StreetSignal\DataSource\Sislog;
...
class Sislog implements CallbackDataSource, OutgoingDataSource
{
    ...
    {
        $router->post('sms/sislog', 'StreetSignal\DataSource\Sislog\SislogController@handleRequest');
    }
