...
namespace StreetSignal\DataSource\SMSSync;
...
class SMSSync implements CallbackDataSource
{
    ...
    {
        $router->post('sms/smssync', 'StreetSignal\DataSource\SMSSync\SMSSyncController@handleRequest');
        $router->post('smssync', 'StreetSignal\DataSource\SMSSync\SMSSyncController@handleRequest');
        $router->get('sms/smssync', 'StreetSignal\DataSource\SMSSync\SMSSyncController@handleRequest');
        $router->get('smssync', 'StreetSignal\DataSource\SMSSync\SMSSyncController@handleRequest');
    }
