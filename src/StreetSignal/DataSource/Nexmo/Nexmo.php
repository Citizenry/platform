...
namespace StreetSignal\DataSource\Nexmo;
...
class Nexmo implements CallbackDataSource, OutgoingDataSource
{
    ...
    public function send($to, $message, $title = "", $contact_type = null)
    {
        ...
        $from = isset($this->config['from']) ? $this->config['from'] : 'StreetSignal';
    ...
    {
        $router->post('sms/nexmo', 'StreetSignal\DataSource\Nexmo\NexmoController@handleRequest');
        $router->get('sms/nexmo', 'StreetSignal\DataSource\Nexmo\NexmoController@handleRequest');
        $router->get('sms/nexmo/reply', 'StreetSignal\DataSource\Nexmo\NexmoController@handleRequest');
        $router->post('sms/nexmo/reply', 'StreetSignal\DataSource\Nexmo\NexmoController@handleRequest');
        $router->post('nexmo', 'StreetSignal\DataSource\Nexmo\NexmoController@handleRequest');
    }
}
