...
/**
 * StreetSignal Import Console Commands
 *
 * @author     StreetSignal Team <team@streetsignal.com>
 * @package    StreetSignal\Modules\V2
 * @copyright  2014 Ushahidi
 * @license    https://www.gnu.org/licenses/agpl-3.0.html GNU Affero General Public License Version 3 (AGPL3)
 */

namespace StreetSignal\Modules\V2\Console;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\DB;
use StreetSignal\Modules\V2;
use StreetSignal\Core\Tool\ManifestLoader;
use Illuminate\Contracts\Bus\Dispatcher;
use StreetSignal\Core\Tool\OhanzeeResolver;
use StreetSignal\Contracts\Repository\Entity\PostRepository;
use StreetSignal\Modules\V2\Contracts\ImportRepository;
...
class ImportFromV2Command extends Command
{
     ...
     * @var string
     */
    protected $description = 'Import StreetSignal V2 database';
