...
namespace StreetSignal\Modules\V2\Jobs;

use StreetSignal\Modules\V2;
...
use StreetSignal\Modules\V2\ManifestSchemas\ImportParameters;
...
class ImportForms extends ImportFromV2Job
{
    ...
    public function handle(
        ...
        $this->formAttributeRepo = $container->make('StreetSignal\Core\Entity\FormAttributeRepository');
        $this->mappingRepo = $container->make('StreetSignal\Modules\V2\Contracts\ImportMappingRepository');
