...
use StreetSignal\Authzn\Session;
...
class LaravelConfig extends ContainerConfig
{
    ...
    protected function configureAuraServices(Container $di)
    {
        ...
        // The StreetSignal filesystem adapter returns a flysystem adapter for a given
        ...
        $di->set('db.ohanzee.resolver', $di->lazy(function () {
            return app(\StreetSignal\Core\Tool\OhanzeeResolver::class);
        }));

        // Configure dispatcher
        $di->setters[\StreetSignal\Core\Concerns\DispatchesEvents::class]
