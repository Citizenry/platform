...
use StreetSignal\Contracts\Repository\Usecase\CreateMessageRepository;
use StreetSignal\Contracts\Repository\Entity\UserRepository;
use StreetSignal\DataSource\Contracts\MessageDirection;
...
class Create extends LegacyValidator
{
    ...
    {
        // @todo inject
        /** @var \StreetSignal\DataSource\DatasourceManager */
