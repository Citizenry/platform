...
/**
 * StreetSignal Export Job Repository
 *
...
use StreetSignal\Modules\V3\Events\SendToHDXEvent;
...
class ExportJobRepository extends BaseRepository implements ExportJobRepositoryContract
{
    ...
    public function __construct(\StreetSignal\Core\Tool\OhanzeeResolver $resolver, PostRepository $post_repo)
    {
    ...
    // StreetSignal_Concerns\JsonTranscode
