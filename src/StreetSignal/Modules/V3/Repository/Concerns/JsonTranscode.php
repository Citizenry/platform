...
/**
 * StreetSignal Json Transcoding Repo Trait
 *
 * JSON encodes properties defined `json_properties`
 * during `executeUpdate` and `executeInsert`
 *
 * @author     StreetSignal Team <team@streetsignal.com>
 * @package    StreetSignal\Application\Controllers
 * @copyright  2013 Ushahidi
 * @license    https://www.gnu.org/licenses/agpl-3.0.html GNU Affero General Public License Version 3 (AGPL3)
 */

namespace StreetSignal\Modules\V3\Repository\Concerns;

use StreetSignal\Core\Tool\JsonTranscode as Transcoder;
