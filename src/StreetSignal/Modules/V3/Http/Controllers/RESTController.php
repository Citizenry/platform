...
abstract class RESTController extends BaseController
{
    ...
    /**
     * @var \StreetSignal\Modules\V3\Factory\UsecaseFactory
     */
    ...
    protected function executeUsecase(Request $request)
    {
        ...
        } catch (\StreetSignal\Core\Exception\NotFoundException $e) {
            abort(404, $e->getMessage());
        } catch (\StreetSignal\Core\Exception\AuthorizerException $e) {
        ...
        } catch (\StreetSignal\Core\Exception\ThrottlingException $e) {
            abort(429, 'Too Many Requests');
        } catch (\StreetSignal\Core\Exception\ValidatorException $e) {
