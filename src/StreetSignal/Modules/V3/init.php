...
/**
 * StreetSignal Platform Bootstrap
 *
...
function service($what = null)
{
    ...
    if (!$di) {
        ...
        $di = $builder->newConfiguredInstance([
            \StreetSignal\Modules\V3\ContainerConfig\CoreConfig::class,
            \StreetSignal\Modules\V3\ContainerConfig\AppConfig::class,
            \StreetSignal\Modules\V3\ContainerConfig\LaravelConfig::class,
        ]);
    }
    if ($what) {
        return $di->get($what);
