    ...
    public function handle(EventInterface $event, $contactIds = null, $form_id = null, $event_type = null)
    {
        ...
        foreach ($contactIds as $contactId) {
            ...
            $messageState = [
                ...
                'status' => \StreetSignal\Core\Entity\Message::PENDING,
                'type' => $message_type,
                'direction' => \StreetSignal\Core\Entity\Message::OUTGOING,
            ...
            $targetedSurveyStatus->setState(
                [
                    ...
                    'post_id' => $postId,
                    'contact_id' => $contactId,
                    'survey_status' => \StreetSignal\Core\Entity\TargetedSurveyState::PENDING_RESPONSE
                ]
            );
