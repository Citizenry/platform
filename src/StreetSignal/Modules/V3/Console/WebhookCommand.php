...
use StreetSignal\Core\Tool\Signer;
...
class WebhookCommand extends Command
{
    ...
    /**
     *
     * @var \StreetSignal\Contracts\Repository\Entity\PostRepository
     */
    private $postRepository;

    /**
     *
     * @var \StreetSignal\Contracts\Repository\Entity\WebhookRepository
     */
    private $webhookRepository;

    /**
     *
     * @var \StreetSignal\Contracts\Repository\Entity\WebhookJobRepository
     */
        ...
        foreach ($webhooks as $webhook) {
            if (! $webhook['form_id'] || ($post && $post->form_id == $webhook['form_id'])) {
                ...
                $promise = $this->client->request('POST', $webhook['url'], [
                    'headers' => [
                        'X-StreetSignal-Signature' => $signature,
