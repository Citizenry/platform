...
namespace StreetSignal\Modules\V5\Models\Post;

use Illuminate\Support\Arr;
use Illuminate\Http\Request;
use Illuminate\Validation\Rule;
use Illuminate\Support\Collection;
use StreetSignal\Modules\V5\Models\Message;
use StreetSignal\Modules\V5\Models\BaseModel;
use StreetSignal\Modules\V5\Rules\StandardText;
use StreetSignal\Modules\V5\Models\Helpers\HideTime;
use StreetSignal\Modules\V5\Models\Helpers\HideAuthor;
use Illuminate\Support\Facades\Request as RequestFacade;
use StreetSignal\Core\Tool\Permissions\InteractsWithPostPermissions;
...
class Post extends BaseModel
{
    ...
    {
        return $this->morphMany('StreetSignal\Modules\V5\Models\Translation', 'translatable');
    } //end translations()
    ...
    {
        return $this->hasOne('StreetSignal\Modules\V5\Models\Survey', 'id', 'form_id')->setEagerLoads([]);
    }

    public function locks()
    {
        //return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostLock', 'post_id', 'id');
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostLock', 'post_id', 'id')
            ->where('post_locks.expires', '>=', time());
    }

    public function categories()
    {
        return $this->belongsToMany('StreetSignal\Modules\V5\Models\Category', 'posts_tags', 'post_id', 'tag_id');
    }

    public function sets()
    {
        return $this->belongsToMany('StreetSignal\Modules\V5\Models\Set', 'posts_sets', 'post_id', 'set_id');
    }

    public function comments()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\Comment', 'post_id', 'id');
    }
    ...
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostVarchar', 'post_id', 'id')
            ->select('post_varchar.*');
    }

    public function valuesText()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostText', 'post_id', 'id')
            ->select('post_text.*');
    }

    public function valuesDatetime()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostDatetime', 'post_id', 'id')
            ->select('post_datetime.*');
    }

    public function valuesDecimal()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostDecimal', 'post_id', 'id')
            ->select('post_decimal.*');
    }

    public function valuesGeometry()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostGeometry', 'post_id', 'id');
    }

    public function valuesInt()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostInt', 'post_id', 'id')
            ->select('post_int.*');
    }

    public function valuesMarkdown()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostMarkdown', 'post_id', 'id')
            ->select('post_markdown.*');
    }

    public function valuesMedia()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostMedia', 'post_id', 'id')
            ->select('post_media.*');
    }

    public function valuesPoint()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostPoint', 'post_id', 'id');
    }

    public function valuesRelation()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostRelation', 'post_id', 'id')
            ->select('post_relation.*');
    }

    public function valuesPostsMedia()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostsMedia', 'post_id', 'id')
    ...
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostsSet', 'post_id', 'id')
            ->select('posts_sets.*');
    }

    public function valuesPostTag()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostTag', 'post_id', 'id')
            ->select('posts_tags.*');
    }

    public function valuesPhone()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostValues\PostPhone', 'post_id', 'id')
            ->select('post_phone.*');
    }

    public function postStages()
    {
        return $this->hasMany('StreetSignal\Modules\V5\Models\PostStages', 'post_id', 'id');
    }
