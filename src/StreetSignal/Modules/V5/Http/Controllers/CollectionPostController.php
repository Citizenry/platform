...
use StreetSignal\Modules\V5\Models\SetPost as CollectionPost;
use StreetSignal\Modules\V5\Http\Resources\Collection\CollectionPostResource;
...
use StreetSignal\Modules\V5\Actions\Collection\Queries\FetchCollectionPostByIdQuery;
use StreetSignal\Modules\V5\Actions\Collection\Commands\DeleteCollectionPostCommand;
use StreetSignal\Modules\V5\Actions\Collection\Commands\CreateCollectionPostCommand;
use StreetSignal\Core\Exception\NotFoundException;
use StreetSignal\Modules\V5\Requests\CollectionPostRequest;
