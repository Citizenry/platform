...
use StreetSignal\Modules\V5\Http\Resources\TosCollection;
use StreetSignal\Modules\V5\Http\Resources\TosResource;
use Illuminate\Http\Request;
use StreetSignal\Modules\V5\Models\Tos;
use StreetSignal\Modules\V5\Actions\Tos\Commands\CreateTosCommand;
use StreetSignal\Modules\V5\Requests\StoreTosRequest;
