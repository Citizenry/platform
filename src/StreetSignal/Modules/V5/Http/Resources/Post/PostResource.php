...
namespace StreetSignal\Modules\V5\Http\Resources\Post;

use Illuminate\Support\Collection;
use StreetSignal\Core\Entity\Post;
use StreetSignal\Modules\V5\Models\Post\Post as v5Post;
use StreetSignal\Modules\V5\Http\Resources\Survey\TaskCollection;
use StreetSignal\Modules\V5\Http\Resources\BaseResource;
use StreetSignal\Modules\V5\Http\Resources\PostValueCollection;
use StreetSignal\Modules\V5\Http\Resources\TranslationCollection;
use StreetSignal\Modules\V5\Http\Resources\ContactPointerResource;
use StreetSignal\Modules\V5\Http\Resources\MessagePointerResource;
use StreetSignal\Modules\V5\Http\Resources\LockCollection;
