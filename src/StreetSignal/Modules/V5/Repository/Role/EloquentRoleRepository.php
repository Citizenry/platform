...
namespace StreetSignal\Modules\V5\Repository\Role;

use StreetSignal\Modules\V5\Models\Role;
use Illuminate\Database\Eloquent\Model;
use StreetSignal\Modules\V5\Repository\Role\RoleRepository as RoleRepository;
use StreetSignal\Core\Exception\NotFoundException;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Facades\DB;
use StreetSignal\Modules\V5\Models\RolePermissions;
