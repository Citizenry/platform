...
namespace StreetSignal\Modules\V5\Repository\Permissions;

use StreetSignal\Modules\V5\Models\Permissions;
use StreetSignal\Modules\V5\Repository\Permissions\PermissionsRepository as PermissionsRepository;
